jQuery(function($) {
    ...
    $(document).on('click', '#wpplc_artist-gallery-metabox a.gallery-add', function(e) {
    ...
    $(document).on('click', '#wpplc_artist-gallery-metabox a.change-image', function(e) {
    ...
    $(document).on('click', '#wpplc_artist-gallery-metabox a.remove-image', function(e) {
        e.preventDefault();
